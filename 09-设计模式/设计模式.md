...
![image-20230521101639915](./images/image-20230521101639915.png)

这次面试部分，我们主要介绍**三种设计模式：**
...
>`开闭原则：`**对扩展开放，对修改关闭**。在程序需要进行拓展的时候，`不能去修改原有的代码`，实现一个热插拔的效果。简言之，是`为了使程序的扩展性好，易于维护和升级`。
...
![image-20230521102022928](./images/image-20230521102022928.png)
...
![image-20230521102122950](./images/image-20230521102122950.png)

流程：

![image-20230521102156863](./images/image-20230521102156863.png)
...
从以上的编写的代码可以看到，要`增加产品类时也要相应地增加工厂类`，`不需要修改工厂类的代码`了，这样就解决了简单工厂模式的缺点。
...
![image-20220913115948157](./images/image-20220913115948157.png)
...
![image-20230521102319997](./images/image-20230521102319997.png)

>实现关系使用带空心三角箭头的虚线来表示

整体调用思路：

![image-20220913124542154](./images/image-20220913124542154.png)
...
1. **简单工厂**
   - 所有的产品都共用一个工厂，如果新增产品，则需要修改代码，违反开闭原则。
   - 是一种编程习惯，可以借鉴这种编程思路。
2. **工厂方法模式**
...
> **开闭原则**
>
> * 新增功能时，尽量通过增加代码来实现，而不是修改已经稳定运行的旧代码。
...
![image-20230521102452501](./images/image-20230521102452501.png)

作为一个程序猿，开发需要选择一款开发工具，当然可以进行代码开发的工具有很多，可以选择Idea进行开发，也可以使用eclipse进行开发，也可以使用其他的一些开发工具。

![image-20220913125131383](./images/image-20220913125131383.png)
...
![image-20220913125209804](./images/image-20220913125209804.png)
...
![image-20230521104504491](./images/image-20230521104504491.png)
...
![image-20230521105346337](./images/image-20230521105346337.png)
...
![image-20230521111455359](./images/image-20230521111455359.png)
...
![image-20230521111943231](./images/image-20230521111943231.png)

类图：

![image-20230521112108550](./images/image-20230521112108550.png)
...
- 内容审核（视频、文章、课程….）
  ...
  ![image-20230521112731617](./images/image-20230521112731617.png)

- 订单创建

  ![image-20230521112802886](./images/image-20230521112802886.png)

- 简易流程审批

  ![image-20230521112831065](./images/image-20230521112831065.png)
